...
set :application, "rb_test_final"
set :application_name, "rb_test_final"  # Required for mina-puma-nginx gem
...
set :branch, ENV["BRANCH"] || DEPLOY_SETTINGS["default_branch"] || "rb-full-test-1752964293"
