  ...
  def up
    unless MailTemplate.where("alias": "reset_password_instructions").any?
      MailTemplate.create(
        ...
        subject:      "[Rails Blueprint] Reset password request",
    ...
    unless MailTemplate.where("alias": "confirmation_instructions").any?
      MailTemplate.create(
        ...
        subject:      "[Rails Blueprint] Please confirm your email",
        body:         "<p>Welcome!</p>\n" \
    ...
    unless MailTemplate.where("alias": "email_changed").any?
      MailTemplate.create(
        "alias":     "email_changed",
        subject:      "[Rails Blueprint] Your email was changed",
    ...
    unless MailTemplate.where("alias": "password_change").any?
      MailTemplate.create(
        ...
        subject:      "[Rails Blueprint] Password change",
        body:         "<p>Hello {{user.first_name}}!</p>\n" \
          "\n" \
    ...
    unless MailTemplate.where("alias": "unlock_instructions").any?
      MailTemplate.create(
        ...
        subject:      "[Rails Blueprint] Your account is locked",
        body:         "<p>Hello {{user.first_name}}!</p>\n" \
          "\n" \
